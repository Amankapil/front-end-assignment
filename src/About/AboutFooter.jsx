          ...
          <div className="foot justify-center flex max-md:flex-col max-xl:flex-wrap max-md:justify-start max-md:items-center ">
            <div className="logo0 mr-11 max-md:mr-0 w-64 -ml-20 max-lg:ml-24">
              <Swiper
                ...
                className="mySwiper  max-lg:h-full max-lg:ml-20"
              >
                <SwiperSlide>
                  <img
                    className=" w-3/4"
                ...
                <SwiperSlide>
                  <h1 className="family text-2xl mt-7">near to Innovation</h1>
                </SwiperSlide>
              </Swiper>
            </div>
            ...
            <div className="inquiri max-md:my-5  max-md:mr-0 mt-3 mr-12 ">
              <Link to="/work">
