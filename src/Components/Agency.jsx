      ...
      <div className="agency flex justify-center w-full items-center mt-52 relative">
        <div className="ag_width flex justify-center -ml-20 max-lg:left-0 max-lg:ml-0  max-w-6xl w-full items-center flex-col ">
          ...
          <div className="works flex flex-col w-full h-full">
            ...
            <div className="-left-48 bg-black w-128 h-128 absolute -rotate-32 -mt-44 -z-0 max-xl:hidden"></div>
            {/* ==================================================== */}
            <div className="images w-full justify-center items-center flex max-md:flex-col  -mt-60 max-lg:mt-32">
              <div className="image_1  mx-20 mt-96 h-full  max-lg:mt-3">
                <div>
                  <img className="check" src="/images/image 3.png" alt="" />
                ...
                <div>
                  ...
                  <img
                    className="check mt-3 h-128 w-full  max-md:mt-3"
                    src="/images/i9.png"
                    alt=""
                  />
                </div>
              ...
              <div className="image_2 -mt-16  max-md:mt-3 ">
                <div>
                  <div className=" max-md:flex  max-md:justify-center">
                    <img
                      className=" check mt-7 max-xl:w-3/4 z-10 "
